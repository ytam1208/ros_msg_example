...
(cl:defmethod cl:initialize-instance :after ((m <AveragingFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AveragingFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name value_msg-msg:<AveragingFeedback> is deprecated: use value_msg-msg:AveragingFeedback instead.")))

(cl:ensure-generic-function 'sample-val :lambda-list '(m))
(cl:defmethod sample-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader value_msg-msg:sample-val is deprecated.  Use value_msg-msg:sample instead.")
  (sample m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader value_msg-msg:data-val is deprecated.  Use value_msg-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'mean-val :lambda-list '(m))
(cl:defmethod mean-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader value_msg-msg:mean-val is deprecated.  Use value_msg-msg:mean instead.")
  (mean m))

(cl:ensure-generic-function 'std_dev-val :lambda-list '(m))
(cl:defmethod std_dev-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader value_msg-msg:std_dev-val is deprecated.  Use value_msg-msg:std_dev instead.")
  (std_dev m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AveragingFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#feedback~%int32 sample~%float32 data~%float32 mean~%float32 std_dev~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AveragingFeedback)))
  "Returns full string definition for message of type 'AveragingFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#feedback~%int32 sample~%float32 data~%float32 mean~%float32 std_dev~%~%~%~%"))
